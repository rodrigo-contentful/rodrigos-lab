...
// func processJSONFile(ctFilename string, contentTypesParsed map[string][]contentTypeParsed) {
	...
	for _, vItem := range obj.Items {
		...
		*/
		for _, vField := range vItem.Fields {
			...
			// if vc,ok:= ctp.FieldsCount[vField.Type];!ok{
			// 	ctp.FieldsCount[vField.Type]=1
			// } else{
			// 	ctp.FieldsCount[vField.Type]=vc+1
			// }
			...
			// err = json.Unmarshal(vField, &fieldsCount)
			// if err != nil {
			// 	fmt.Println("error:", err)
			// 	continue
			// }
			// ctp.FieldsCount=fieldsCount
	...
	//Content Types: 'Two Column Layout' , 'Templated Layout'
	// testA:= "Homepage Attraqt Zone"
	// testB:= "Call to action"
	// testA:= "Two Column Layout"
	// testB:= "Templated Layout"
	// seqMatcherA := NewMatcher(splitChars(testA),splitChars(testB))
	
	// fmt.Println(seqMatcherA.QuickRatio())
	// fmt.Println(seqMatcherA.Ratio())
	// fmt.Println(seqMatcherA.RealQuickRatio())
	...
	for itemIndex,itemValue := range ctItems{
		...
		for _,itemStep := range ctItems[(itemIndex+1):]{	
			// if bytes.Equal(itemValue.Hash,itemStep.Hash){	
			// 	SimilarContentTypesFormat("","",itemValue.Name,itemStep.Name,itemValue.FieldsCount)
			// }

			SimilarContentTypesFormat2(itemValue,itemStep,nameThreshhold, fieldsThreshold,"","")
		...
		for _,SecondSpaceValue := range contentTypesParsed[(firstSpaceIndex+1):]{	
			...
			for _, firstSpaceValueType := range firstSpaceValue.ItemsCount {
				for _, SecondSpaceValueType := range SecondSpaceValue.ItemsCount {
					// if bytes.Equal(firstSpaceValueType.Hash,SecondSpaceValueType.Hash){
					// 		SimilarContentTypesFormat(firstSpaceValue.Name,SecondSpaceValue.Name,firstSpaceValueType.Name,SecondSpaceValueType.Name,firstSpaceValueType.FieldsCount)
							
					// }
					SimilarContentTypesFormat2(firstSpaceValueType,SecondSpaceValueType,nameThreshhold, fieldsThreshold,firstSpaceValue.Name,SecondSpaceValue.Name)
				}
			}
...
func SimilarContentTypesFormat(spaceIdA,spaceIdB,typeIdA,typeIdB string, fields []fieldItemsHashCheck ){
	seqMatcher := NewMatcher(splitChars(typeIdA),splitChars(typeIdB))
	if (seqMatcher.QuickRatio() >= simLowerLimitPrecentageName){
...
func SimilarContentTypesFormat2(itemA,itemB contentTypeParsed, nameThreshhold, fieldsThreshold float64 ,spaceIdA, spaceIdB string){
...
func main() {
	...
	// test11 := fieldItemsHashCheck{
	// 	Type:"Array",
	// 	Required:true,
	// }
	// test12 := fieldItemsHashCheck{
	// 	Type:"Symbol",
	// 	Required:true,
	// }
	// test13 := fieldItemsHashCheck{
	// 	Type:"Symbol",
	// 	Required:true,
	// }

	// rr1,_:=json.Marshal(&test11)
	// rr2,_:=json.Marshal(&test12)
	// rr3,_:=json.Marshal(&test13)
	// // fmt.Println(string(rr))
	// test1:= strings.Join([]string{string(rr1),string(rr2),string(rr3)},"\n")

	// // test1:= `
	// // Type: Symbol; Required: false; Omitted: false; Disabled: false; Localized: true
	// // Type: Array; Required: false; Omitted: false; Disabled: false; Localized: true
	// // Type: Int; Required: false; Omitted: false; Disabled: false; Localized: true`

	// test21 := fieldItemsHashCheck{
	// 	Type:"Symbol",
	// 	Required:true,
	// }
	// test22 := fieldItemsHashCheck{
	// 	Type:"Symbol",
	// 	Required:true,
	// }
	// test23 := fieldItemsHashCheck{
	// 	Type:"Array",
	// 	Required:true,
	// }
	// rr12,_:=json.Marshal(&test21)
	// rr22,_:=json.Marshal(&test22)
	// rr32,_:=json.Marshal(&test23)
	// test2:= strings.Join([]string{string(rr12),string(rr22),string(rr32)},"\n")
	// // test2:= `
	// // Type: Int; Required: false; Omitted: false; Disabled: false; Localized: true
	// // Type: Symbol; Required: false; Omitted: false; Disabled: false; Localized: true
	// // Type: Array; Required: false; Omitted: false; Disabled: false; Localized: true`
	...
	// fmt.Printf("%+v",test2)
	// fmt.Println()
	// // test1= strings.TrimSpace(test1)
	// // test2= strings.TrimSpace(test2)

	// seqMatcher := NewMatcher(SplitLines(test1),SplitLines(test2))
	// fmt.Printf("%f", seqMatcher.QuickRatio())
}
